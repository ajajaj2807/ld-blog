...
export default function code() {
  ...
  return (
    <div className="coding-wrapper">
      <NextSeo title="Coding Interview Questions" />
      <Header />
      <h1>Coding Questions</h1>
      <b>
        A curated list of questions to practice algorithms and data structures
      ...
      <div className="cs-code">
        <span>
          More questions and features coming soon. <br />
          Contact me to add a question.
        </span>
      </div>
    </div>
  );
